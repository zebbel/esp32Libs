...
/**
 * @brief Returns the division of two quaternions.
 * @param quaternionA Quaternion A.
 * @param quaternionB Quaternion B.
 * @return Division of two quaternions.
 */
static inline FusionQuaternion FusionQuaternionDivide(const FusionQuaternion quaternionA, const FusionQuaternion quaternionB) {
#define A quaternionA.element
#define B quaternionB.element
    const FusionQuaternion result = {.element = {
            .w = A.w * B.w - A.x * (-1.0f * B.x) - A.y * (-1.0f * B.y) - A.z * (-1.0f * B.z),
            .x = A.w * (-1.0f * B.x) + A.x * B.w + A.y * (-1.0f * B.z) - A.z * (-1.0f * B.y),
            .y = A.w * (-1.0f * B.y) - A.x * (-1.0f * B.z) + A.y * B.w + A.z * (-1.0f * B.x),
            .z = A.w * (-1.0f * B.z) + A.x * (-1.0f * B.y) - A.y * (-1.0f * B.x) + A.z * B.w,
    }};
    return result;
#undef A
#undef B
